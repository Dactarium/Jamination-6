...
public class PatternEditor : EditorWindow 
{
    ...
    {   
        ...
        EditorGUILayout.BeginHorizontal();
        {
	        ...
	        EditorGUILayout.BeginVertical(GUILayout.MaxWidth(leftWidth));
	        {
    ...
    void GUINewPatternSetting(){
        ...
        switch(patternType){
            ...
            case PatternType.Entity:
	            entityPattern = setPatternArray(entityPattern);
	            entityPatternVertical = setPatternSideArray(entityPatternVertical, true);
	            entityPatternHorizontal = setPatternSideArray(entityPatternHorizontal, false);
	            break;
        }
        ...
        if(GUILayout.Button("Save Pattern", GUILayout.Width(width-6))){
            ...
            switch(patternType){
                ...
                case PatternType.String:
                    ...
                    break;
                case PatternType.Entity:
	                WriteToJsonFile(path, JsonUtility.ToJson(patternToData(entityPattern, PatternType.Entity)));
	                break;
            }
